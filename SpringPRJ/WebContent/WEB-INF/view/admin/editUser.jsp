...
<body>
	...
	<br>
	<div id="container">
		<form name="editForm" action="/admin/DoEditUser.do" method="post">
		<p>이름</p>
		...
		<br>
		<button type="submit" style="width: 100%;" class="genric-btn primary radius">수정하기</button>
		</form>
		<br>
		<a href="/admin/UserList.do" style="width: 100%;" class="genric-btn danger radius">취소</a>
	</div>
